...
public class BarcodeCam : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        camTexture.requestedHeight = Screen.height/3; // 480;
        camTexture.requestedWidth = Screen.width/3; //640;
        OnEnable();
    ...
    public void DoWhenEnable()
    {
        ...
        screenRect = new Rect(0, 0, Screen.width/3, Screen.height/3);
    ...
    void Update()
    {
            ...
            textForEncoding != null)
        {
            ...
            if(flag2 == 1)
            {
                this.GetComponent<NewBehaviourScript>().StrFunc(LastResult);
                flag2 = 0;
            }
            flag = 0;
            //OnDisable();
